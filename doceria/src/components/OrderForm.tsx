  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          <h3 className="text-lg font-semibold mb-4 text-gray-700">Itens do Pedido</h3>
          {items.map((item, index) => (
            <div key={index} className="flex gap-2 mb-3 p-3 border rounded-lg">
              <input
                type="text"
              ...
              <input
                ...
                required
              />
              <div className="w-24 p-2 border rounded bg-gray-100 flex items-center justify-center font-semibold">
